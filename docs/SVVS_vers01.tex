...
\begin{testlist}
    ...
    \item When no device is selected, the "Controll device" button is not clickable. (Req 5.2.4)
    \item The screen displays the number of items in the list. (Req 5.2.5)
    \item When the application is started the list of available devices is empty. (Req 5.2.6)
    \item The devices are named in accordance with relevant document. (Which document is unknown at present.) (Req 5.2.7)
...
\item There are text fields preceded by "T", "P", "H", "M", "G", "A" that are used to display temperature, pressure, humidity, magnetic field, gyroscopic value and acceleration. The displayed values correspond to the letter preceding the field.(Req. 5.3.5, 5.3.6, 5.3.7, 5.3.8, 5.3.9, 5.3.10)
...
\item If there is no data to retrieve for any of the physical quantities temperature, pressure, humidity, magnetic field, gyroscopic and acceleration when a relevant "Get" button is pressed the corresponding text fields display "No data available".(Req. 5.3.19, 5.3.20, 5.3.21, 5.3.22, 5.3.23, 5.3.24)
