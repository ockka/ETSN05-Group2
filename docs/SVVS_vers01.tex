...
\item There are text fields preceded by "T", "P", "H", "M", "G", "A" that are used to, respectively, display temperature, pressure, humidity, magnetic field, gyroscopic value and acceleration. The displayed values correspond to the letter preceding the field.(Req. 5.3.5, 5.3.6, 5.3.7, 5.3.8, 5.3.9, 5.3.10)
...
\begin{testlist}
	...
	\item Use case 5.1.12 is supported (Req. 5.1.12)
\end{testlist}
