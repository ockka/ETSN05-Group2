...
\item[]
\begin{itemize}
\item [\ref{1}:] One or more devices not found.
\item The user is notified by the pop-up message: "Device(s) not found.".
\end{itemize}
...
\begin{itemize}
\item The user is notified by the pop-up message: "Error "HTTP Status-Code" occurred".
\end{itemize}
\end{enumerate}
