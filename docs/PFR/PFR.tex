...
The scheduling and time planning within the group have received very positive response from the group. The project managers put a lot of time into working out a reasonable schedule that would also make sure that the project was delivered prior to external commitments the team members had at the end of the time period scheduled for this project. This means that the deadlines sometimes were fairly tight, but the team has been motivated to meet them due to it being to their personal advantage. At the time of this report being written, the deadlines have all been successfully met so far. 
...
Large differences in amount of hours spent on the project in the test group. Those with more technical knowledge have had to "fix" more problems etc.

Delade meningar om hur bra arbetsfördelningen fungerat i TG. Bra på det stora hela, men de med större tekniska kunskaper har fått dra ett större strå till stacken.
...
Large differences in technical knowledge (git and LaTex) in TG.
