...
The project managers are very satisfied with the quality of the documents so far delivered and believe without a doubt that with the help of the system architects and testers, the developers will be able to finish the application on schedule and with a satisfactory result.
...
Orättvis fördelning då vissa hade mer tekniska kunskaper, låt de andra göra med av jobbet för att kompensera för detta. 
