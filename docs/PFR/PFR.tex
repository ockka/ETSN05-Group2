...
\item[System Architects] Responsible for the technical part of the project and also communications between the developers and testers. Consisted of three people, one of whom was system manager.
\item[Developers] Eight developers have been responsible for the coding of the application.
\item[Test Group] Six testers have been responsible for testing the developed system.
\end{description}
...
When the questionnaire was sent out and this report written before the product was completely finished. Estimations have therefore been made with respect to how satisfied the team will be with the final product. A lot of confidence was shown throughout the replies of the questionnaire, that the developers will be able to present a application that reflects the team's efforts and hard work. 
