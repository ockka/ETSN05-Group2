...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW   ===============POSTCONDITIONS OMFORMULERADE TILL CHECKS, SAMMANSLAGNING AV TEST
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW =====================SAMMANSLAGNING AV TEST, SE ÄVEN NEDAN
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW ===========================SAMMANSLAGNING AV TEST
	\item
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW ================================= BRYTNING AV KONFIGURATIONSLÖS LOOP, OMFORMULERING AV POSTCONDITIONS TILL CHECKS
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW ============================SAMMANSLAGNING AV TEST, SE OVAN
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW ====================SAMMANSAGNING AV TEST, SE OVAN
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW =======================BRYTNING AV KONFIGURATIONSLOOP
%
%	\item 
%		\begin{config}[five]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW ==================OMFORMULERING AV POSTCONDITION TILL CHECK
	\item
		\begin{precondition}
			\item The Light Bulb View is open
			\item The light bulb is off
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW ==================SAMMANSLAGNING AV TEST, SE NEDAN
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CHANGES BELOW =============================BRYTNING AV KONFIGURATIONSLÖS LOOP, OMFORMULERING AV POSTCONDITIONS TILL CHECKS
	...
	\item
		...
		\end{instruction}
		\begin{postcondition}
			\item The error message is displayed after 15 seconds %Jag gissar att det här är vad det är.
		\end{postcondition}
