...
\begin{testlist}
    ...
    \item Test of startup screen of application.
    	\begin{precondition}
...
\begin{testlist}
	\item Test of transition from main view to sensor view.
 		\begin{precondition}
 			\item The MyDevices View is open
...
\begin{testlist}
    ...
    \item Test of transition from MyDevices View to Light Bulb View.
    	\begin{precondition}
    		\item The MyDevices View is open
