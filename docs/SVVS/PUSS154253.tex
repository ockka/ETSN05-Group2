...
\begin{flushright}
PUSS154253 \version\  %Dokumentnummer enl. projekthandledning s. 22-23 och insidan av pärmen
\today
\end{flushright}
\end{minipage}\\[3cm]
...
\HRule \\[0.4cm]
{ \huge \bfseries Test Matrices for \SVVS\ }\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
