...
\textit{\large Version History}
    ...
    1.0					& 2015-09-15 			& OF						& Baseline								\\ \hline
    1.1					& 2015-09-25			& UH \& ME					& Added test A.1.12 					\\ \hline
    1.2					& 2015-10-01			& HA						& Changes according to PR5				\\ \hline
    1.3					& 2015-10-08			& HA						& Changes according to PR8				\\ \hline
    1.4					& 2015-10-08			& HA						& Changes according to PR13				\\ \hline
    \end{tabular}
\end{center}
...
\item If there is no data to retrieve for any of the physical quantities: temperature, pressure, humidity, magnetic field strength, gyroscopic data and acceleration when the corresponding "Get" button is pressed a pop-up message is shown. (Req. 5.3.19, 5.3.20, 5.3.21, 5.3.22, 5.3.23, 5.3.24).
...
\item If there is no data from the past ten minutes, pressing a ''Get''-button causes a pop-up message.  (Req. 5.3.29).
...
\begin{testlist}
    ...
    \item A pop-up is displayed when the values of the light bulb were unsuccessfully set. (Req 5.4.15)
...
\begin{testlist}
	...
	\item If some data is unavailable when attempting scenario 5.1.9, a pop-up message is shown (Req. 5.1.9).
	
	\item Scenario 5.1.10 in Ref \ref{refdocs:srs} is supported (Req. 5.1.10).
	
	\item If some data is unavailable when attempting scenario 5.1.10, a pop-up message is shown (Req. 5.1.10).
	
	\item Scenario 5.1.11 in Ref \ref{refdocs:srs} is supported (Req. 5.1.11).
	
	\item If some data is unavailable when attempting scenario 5.1.11, a pop-up message is shown (Req. 5.1.11).
